...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1999592597;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        19 => wire__crate__api__local_session__LocalSession_send_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__local_session__LocalSession_set_task_pinned_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__local_session__LocalSession_subscribe_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__local_session__LocalSession_subscribe_worker_replies_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__local_session__LocalSession_tab_resize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__embedded_daemon__boot_embedded_daemon_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__iroh_client__init_app_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__iroh_client__iroh_connect_impl(port, ptr, rust_vec_len, data_len),
        27 => {
            wire__crate__api__local_session__local_connect_impl(port, ptr, rust_vec_len, data_len)
        }
        28 => wire__crate__api__pair__pairing_info_impl(port, ptr, rust_vec_len, data_len),
        29 => {
            wire__crate__api__pair__regenerate_local_pairing_impl(port, ptr, rust_vec_len, data_len)
        }
        30 => wire__crate__api__iroh_client__set_data_dir_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
