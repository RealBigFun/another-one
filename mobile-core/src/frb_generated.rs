...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1176474488;
...
fn wire__crate__api__iroh_client__IrohSession_watch_project_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "IrohSession_watch_project",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = crate::api::iroh_client::IrohSession::watch_project(
                            &*api_that_guard,
                            api_project_path,
                        )
                        .await?;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__iroh_client__IrohSession_watch_project_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__iroh_client__init_app_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__iroh_client__iroh_connect_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__iroh_client__set_data_dir_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
mod io {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_mobile_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerIrohSession(
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_mobile_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerIrohSession(
        ptr: *const std::ffi::c_void,
    ) {
