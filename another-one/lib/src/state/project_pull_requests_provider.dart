...
final projectPullRequestsProvider =
    makeConnectionFutureProviderFamily<
      List<ProjectPagePullRequestDto>?,
      ProjectPullRequestsKey
    >(
      read: (_, connection, key) => connection.findProjectPullRequests(
